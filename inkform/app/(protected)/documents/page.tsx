        ...
        if (studio) {
          ...
          if (formError) {
            ...
            const transformedData = formData.map((doc) => ({
              ...doc,
              appointment: Array.isArray(doc.appointment) ? doc.appointment[0] : doc.appointment,
            })) as FormDocument[];
            ...
            {filteredDocuments.length === 0 ? (
              ...
              filteredDocuments.map((doc) => (
                <TableRow key={doc.id}>
                  ...
                  <TableCell>
                    {doc.appointment?.appointment_date ? format(new Date(doc.appointment.appointment_date), 'PPP') : 'N/A'}
                  </TableCell>
                  <TableCell>
            ...
            <Card key={doc.id}>
              ...
              <CardContent className="space-y-3">
                <div className="flex items-center space-x-2 text-sm text-gray-600">
                  ...
                  <span>Appointment: {doc.appointment?.appointment_date ? format(new Date(doc.appointment.appointment_date), 'PPP') : 'N/A'}</span>
                </div>
                <div className="flex items-center space-x-2 text-sm text-gray-600">
